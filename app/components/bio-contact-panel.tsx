      ...
      <div className="flex h-full flex-col p-4">
        {bioOpen && !bioExpanded ? (
          <div key="bio-preview" className="info-panel-fade flex h-full flex-col">
            <p className={`m-0 text-sm leading-tight ${textColorClass}`}>
              {firstBioParagraph}
            </p>
            <button
              type="button"
        ...
        {bioExpanded ? (
          <div
            key="bio-expanded"
            className={`info-panel-fade bio-scroll-fade mt-2 overflow-y-auto pb-12 pr-2 text-sm leading-snug ${textColorClass} [scrollbar-color:#9a9a9a_transparent] [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:border-2 [&::-webkit-scrollbar-thumb]:border-[#e8dfd0] [&::-webkit-scrollbar-thumb]:bg-[#9a9a9a] [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar]:w-2.5`}
          >
