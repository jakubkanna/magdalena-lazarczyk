      ...
      {variant === "minimized" ? (
        <div className="flex h-full flex-col items-center justify-between pl-2 pr-4 py-5 max-md:h-auto max-md:w-full max-md:flex-row max-md:flex-nowrap max-md:px-1.5 max-md:py-1">
          <div className="flex w-full flex-col items-center gap-2 max-md:w-auto max-md:min-w-0 max-md:flex-row max-md:flex-nowrap max-md:justify-between">
            <button
              type="button"
              className={`sidebar-mini-logo flex size-11 shrink-0 cursor-pointer appearance-none items-center justify-center rounded-full bg-transparent p-3 text-center text-2xl font-normal leading-none transition-[background-color,color,box-shadow,transform] duration-500 max-md:size-14 max-md:text-4xl ${sidebarTextClass} ${sidebarHoverClass}`}
              onClick={onHomeClick}
